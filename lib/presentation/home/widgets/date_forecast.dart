          ...
          image: DecorationImage(
            image: Image.asset(
              state.currentForecast == null
                  ? AssetConstants.day
                  : GenericHelpers.getWeatherBackgroundImage(
                      state.currentForecast!.weather.first.main),
            ).image,
            fit: BoxFit.cover,
          ),
        ),
                  ...
                  children: [
                          ...
                          ? () {
                              BlocProvider.of<HomeBloc>(context).add(
                                HomeEvent.updateCurrentDate(
                                  newDate:
                                      state.dates[state.currentDateIndex - 1],
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color: state.currentDateIndex < state.dates.length - 1
                              ? Theme.of(context)
                                  .scaffoldBackgroundColor
                                  .withOpacity(.5)
                              : Colors.grey.withOpacity(0.5),
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final DateTime time = GenericHelpers.convertToLocalTime(
                      ...
                      return GestureDetector(
                        onTap: () {
                          context.read<HomeBloc>().add(
                              HomeEvent.switchForecast(forecast: forecast));
                        },
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Container(
